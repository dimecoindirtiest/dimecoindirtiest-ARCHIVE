...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "dimecoindirtiest " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    ...
    {"178.157.251.75", "178.157.251.75"},
    {"107.170.156.17", "107.170.156.17"},
    {"84.18.120.152", "84.18.120.152"},
    {"73.9.181.217", "73.9.181.217"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. dimecoindirtiest is probably already running."), addrBind.ToString().c_str());
        else
